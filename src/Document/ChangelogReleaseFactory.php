...
/**
 * Constructs changelog release value objects.
 */
final readonly class ChangelogReleaseFactory implements ChangelogReleaseFactoryInterface
{
    /**
    ...
    {
        return new ChangelogRelease($version, $date, $entries);
    }
}
